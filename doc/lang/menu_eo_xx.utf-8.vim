...
menutrans Toggle\ &auto-indent<Tab>:set\ ai!		Baskuli\ &autokrommarĝenon<Tab>:set\ ai!
menutrans Toggle\ &C-indenting<Tab>:set\ cin!		Baskuli\ &C-krommarĝenon<Tab>:set\ cin!
" -SEP2-
menutrans &Shiftwidth					&Largo\ de\ krommarĝeno
menutrans Soft\ &Tabstop				&Malm&olaj\ taboj
menutrans Te&xt\ Width\.\.\.				Largo\ de\ te&ksto\.\.\.
menutrans &File\ Format\.\.\.				&Formato\ de\ &dosiero\.\.\.

let g:menutrans_textwidth_dialog = "Tajpu la novan largon de teksto\n(0 por malŝalti formatigon)."
...
" -SEP2-
menutrans Fold\ col&umn\ width				&Largo\ de\ falda\ kolumno
...
menutrans Max\ &Width<Tab>^W\|			Maksimuma\ &largo<Tab>^W\|
menutrans Min\ Widt&h<Tab>^W1\|			Minimuma\ lar&go<Tab>^W1\|
...
menutrans WinMaxWidth				MaksLargFen
menutrans WinMinWidth				MinLargFen
...
fun! Do_toolbar_tmenu()
 ...
 if 0	" disabled; These are in the Windows menu
  ...
  tmenu ToolBar.WinMaxWidth			Maksimumi largon de fenestro
  tmenu ToolBar.WinMinWidth			Minimumi largon de fenestro
